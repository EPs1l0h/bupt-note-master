...
//                    try {
                    String absolutePath = getPath(this, backgroundUri);
                    System.out.println("绝对路径为：" + absolutePath);
                    Bitmap backgroundBitmap = BitmapFactory.decodeFile(absolutePath);
...
//                    setContentView(R.layout.activity_list_background);
                    setContentView(R.layout.note_list);
                    initResources();
//                    setContentView(R.layout.note_list_footer);
//                    setContentView(R.layout.note_edit_list_item);
 
                        Toast.makeText(NotesListActivity.this, "更改背景成功！", Toast.LENGTH_SHORT).show();
//                    } catch (FileNotFoundException e) {
//                        Log.d(TAG, "onActivityResult: get file_exception");
//                        e.printStackTrace();
//                        Toast.makeText(NotesListActivity.this, "无法加载背景图片", Toast.LENGTH_SHORT).show();
//                    }
                } else {
                    Toast.makeText(NotesListActivity.this, "未选择背景图片", Toast.LENGTH_SHORT).show();
                }
                break;
...
//            // DownloadsProvider
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.menu_new_folder) {
            ...
            onSearchRequested();
        } else if (itemId == R.id.menu_change_background) {
...
//        } else if (itemId == R.id.menu_cosine_search){
//            onSearchRequested();
//        }
...
//
//                        Log.e(TAG, "查询结果字符串" + searchResult.toString());
//                        if(searchResult.isEmpty()){
//                            List<String> cosine_Result = dbHelper.cosine_Search(queryString);
//                            Intent showResultIntent = new Intent(NotesListActivity.this, showResultActivity.class);
